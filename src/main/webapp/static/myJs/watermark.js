...
function watermark(settings) {
    ...
    var defaultSettings={
        watermark_txt:"text",
        watermark_x:-520,//水印起始位置x轴坐标
        watermark_y:-520,//水印起始位置Y轴坐标
        watermark_rows:25,//水印行数
        watermark_cols:25,//水印列数
        watermark_x_space:110,//水印x轴间隔
        watermark_y_space:40,//水印y轴间隔
        watermark_color:'#555555',//水印字体颜色
