...
<input type="text" id="${name}" name="${name}" maxlength="5" class="itxt itxt-error required" style="font-weight:bold;width:80px;${inputCssStyle};border: 1px" onkeydown="keyDownEnter(event)" />
