...
<button class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" onclick="consult()" title="查阅"><i class="fa fa-file-text-o"></i> ${label==null?'查阅':label}</button>
                        </button>
...
$(document).ready(function() {
	...
	function consult(){
        ...
        top.layer.confirm('确认要查阅这些数据吗?', {icon: 3, title:'系统提示'}, function(index){
