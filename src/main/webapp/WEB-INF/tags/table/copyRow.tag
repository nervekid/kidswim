...
<button class="btn btn-success btn-sm" onclick="copyAll()" data-toggle="tooltip" data-placement="top"><i class="fa fa-trash-o"> ${label==null?'复制':label}</i>
</button>
...
<script type="text/javascript">
    ...
    function copyAll(){
        ...
        top.layer.confirm('确认要彻底复制数据吗?', {icon: 3, title:'系统提示'}, function(index){
