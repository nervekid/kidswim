...
<button class="btn btn-success btn-sm" onclick="sendAll()" data-toggle="tooltip" data-placement="top"><i class="fa fa-twitch"> ${label==null?'发送':label}</i>
</button>
...
<script type="text/javascript">
    ...
    function sendAll(){
        ...
        top.layer.confirm('确认对选择数据进行短信推送吗?', {icon: 3, title:'系统提示'}, function(index){
