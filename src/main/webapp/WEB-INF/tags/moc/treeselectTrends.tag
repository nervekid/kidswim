...
<%@ attribute name="notAllowSelectParent" type="java.lang.Boolean" required="false" description=" "%>
...
<%@ attribute name="setCustomerIdValue" type="java.lang.String" required="false" description="需要填充客户ID中文单元格"%>
...
<script type="text/javascript">
    $("#${id}Button, #${id}Name").click(function(){
        ...
        top.layer.open({
            ...
            content: "${ctx}/tag/treeselectMoc?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}&yearMonth="+yearmonthValue ,
            btn: ['确定', '关闭']
            ,yes: function(index, layero){ //或者使用btn1
                ...
                for(var i=0; i<nodes.length; i++) {//<c:if test="${checked && notAllowSelectParent}">
                    ...
                    var ifsetCustomerIdValue = '${setCustomerIdValue}';
                    if(ifsetCustomerIdValue != '') {
                        var $setCustomerIdValue =  $("#"+ifsetCustomerIdValue);
                        var customerId = nodes[i].customerId;
                        console.log("customerId:"+customerId);
                        $setCustomerIdValue.val(customerId);
                    }
