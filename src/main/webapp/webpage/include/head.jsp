<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.kite.org/"/>
...
<!-- 自定义扩展验证 -->
<script src="${ctxStatic}/jquery-validation/1.14.0/validate_methodexpand.js" type="text/javascript"></script>
...
<!-- kite -->
<link href="${ctxStatic}/common/kite.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/kite.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/jquery-select2/3.4/select2-bootstrap.css" rel="stylesheet"/>
...
<!-- 引入JS计算 -->
<script src="${ctxStatic}/common/calculate.js"  type="text/javascript">
<!--
...
<script src="${ctxStatic}/bootstrap/3.3.4/js/bootstrap-table.js"  type="text/javascript"></script>
<script src="${ctxStatic}/bootstrap/3.3.4/js/bootstrap-table-fixed-columns.js"  type="text/javascript"></script>
<link href="${ctxStatic}/bootstrap/3.3.4/css_default/bootstrap-table.css" type="text/css" rel="stylesheet" />
<link href="${ctxStatic}/bootstrap/3.3.4/css_default/bootstrap-table-fixed-columns.css" type="text/css" rel="stylesheet" />

<!-- 文件上传文件-->
<%--<link rel="stylesheet" type="text/css"   href="${ctxStatic}/fileinput/css/fileinput.min.css" />--%>
