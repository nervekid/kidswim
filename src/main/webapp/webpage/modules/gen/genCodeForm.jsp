...
<form:form id="inputForm" modelAttribute="genScheme" method="post" action="${ctx}/gen/genTable/genCode"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="category" class="required form-control">
                <form:options items="${config.categoryList}" itemValue="value" itemLabel="label"/>
            </form:select>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="packageName" maxlength="500" class="required form-control"/>
            <span class="help-inline">建议模块包：com.kite.modules</span>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label"><font color="red">*</font>生成模块名:</label>
        <div class="controls">
            <form:input path="moduleName" maxlength="500" class="required form-control"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="functionName" maxlength="500" class="required form-control"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="functionNameSimple" maxlength="500" class="required form-control"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="functionAuthor" maxlength="500" class="required form-control"/>
