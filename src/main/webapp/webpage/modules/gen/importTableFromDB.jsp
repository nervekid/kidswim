...
<div class="wrapper wrapper-content">
    ...
    <!-- 业务表导入 -->
    <form:form id="inputForm" modelAttribute="genTable" action="${ctx}/gen/genTable/importTableFromDB" method="post"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:select path="name" class="form-control ">
                    <form:options itemValue="name" itemLabel="nameAndComments" items="${tableList}"/>
                </form:select>
            </div>
        </div>
    </form:form>
