...
<form:form id="inputForm" modelAttribute="menu" method="post" action="${ctx}/gen/genScheme/createMenu"
    ...
    <table class="table table-bordered table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td class="width-35">
                <form:input path="name" maxlength="50" class="required form-control"/>
            </td>
        </tr>
        <tr>
            ...
            <td class="width-35">
                <form:input path="sort" maxlength="50" class="required digits form-control"/>
