		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:select placeholder="性别" path="sex"  class="form-control m-b"  disabled="true" >
				...
				<tr>
					...
					<td class="width-35">
						<form:select placeholder="有否合约" path="contractFlag"  class="form-control m-b" disabled="true" >
							<form:option value="" label="请选择"/>
