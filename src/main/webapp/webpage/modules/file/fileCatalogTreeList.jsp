...
<head>
    ...
    <script type="text/javascript">
        function refresh(){//刷新
            window.location="${ctx}/file/fileCatalog/listTree";
        }
    </script>
</head>
    ...
    <div class="ibox-content">
        ...
        <div id="content" class="row">
            ...
            <div id="right"  class="col-sm-11  animated fadeInRight">
                <iframe id="fileCatalogContent" name="fileCatalogContent" src="${ctx}/file/fileCatalog/listAll?id=&parentIds=" width="100%" height="91%" frameborder="0"></iframe>
            </div>
        </div>
     </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
            callback:{onClick:function(event, treeId, treeNode){
                    ...
                    $('#fileCatalogContent').attr("src","${ctx}/file/fileCatalog/listAll?id="+id+"&parentIds="+treeNode.pIds);
                }
            }
        };
