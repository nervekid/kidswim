...
//	private Integer sort;		// 排序
	...
	private String unOrganTag; //反-组织架构标记
	private String organName; //组织架构标记名称
	private String currentUserId; //当前登录人id
	private String firstFlag;//是否需要刷新父页面
...
//		this.sort = 30;
	...
	public String getUnOrganTag() {
		return unOrganTag;
	}

	public void setUnOrganTag(String unOrganTag) {
		this.unOrganTag = unOrganTag;
	}
