...
//	private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	...
	private String simpleName;	//无前缀的名称
	private String roleLabel;	//角色类型
...
//	}
    ...
    @ExcelField(title = "系统模块", dictType = "sysModules", align = 2, sort = 11)
	public String getSysModules() {
		return sysModules;
	}

	public void setSysModules(String sysModules) {
