 ...
 * MouTai
 */
package com.kite.modules.gen.util;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.kite.common.config.Global;
import com.kite.common.mapper.JaxbMapper;
import com.kite.common.utils.DateUtils;
import com.kite.common.utils.FileUtils;
import com.kite.common.utils.FreeMarkers;
...
public class GenUtils {
	...
	public static void initColumnField(GenTable genTable){
		for (GenTableColumn column : genTable.getColumnList()){
			...
			// 设置java字段名2018-04-25 取消
			//column.setJavaField(StringUtils.toCamelCase(column.getName()));
			
			// 设置java字段名2018-04-25 生效，只要是把自动转成大小写的功能去掉
			column.setJavaField(StringUtils.toCamelCaseNoLower(column.getName()));
